...
//Main Window, setting up animations n such
    ...
    , ui(new Ui::MainWindow)
{
    ...
    animation->setStartValue(QPoint(25,45));
    animation->setEndValue(QPoint(25,25));
    animation->setDirection(QAbstractAnimation::Forward);
    animation2=new QPropertyAnimation(ui->logo, "pos");
    animation2->setDuration(250);
    animation2->setStartValue(QPoint(25,25));
    animation2->setEndValue(QPoint(25,45));
...
//Print text one letter at a time based on timer 1 + 2. Remove text from 'message_to_print' when swapping combo box bots.
...
//Displaying the text, starting timer 3
...
void MainWindow::onmessageDataRecieved()
{
    ...
    QString Again2 = ("Send again, or swap the translator?");
...
//Everything that changes when ComboBox is changed:
//1)Clears result box
//2)Changes the 2 push button texts
//3)Adds character image in logo
//4)Adds random fun fact to the label at the bottom
//5)Changes the font within the result box
...
void MainWindow::on_comboBox_currentTextChanged(const QString &arg1)
{
    ...
    QFont font1("KINGDOM CROWN", 20, QFont::Bold);
    ...
    else if (ui->comboBox->currentText()== "French")
    {
        ...
        QFont font2("Script", 20, QFont::Bold);
    ...
    else if (ui->comboBox->currentText()== "Pirate")
    {
        ...
        QFont font3("MV Boli", 20, QFont::Bold);
    ...
    else if (ui->comboBox->currentText()== "Backwards")
    {
        ...
        QFont font4("Terminal", 12, QFont::Bold);
    ...
    else if (ui->comboBox->currentText()== "Spoiled Victorian Child")
    {
        ...
        QFont font5("Roman", 20, QFont::Bold);
    ...
    else if (ui->comboBox->currentText()== "Binary")
    {
        ...
        QFont font6("Terminal", 12, QFont::Bold);
...
//Stacked Widget navigation button
